...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["save"])) {
    ...
    // Prepare and execute the query to insert data into the hd_department table
    $insertQuery = "INSERT INTO hd_department (name, status) VALUES ('$departmentName', '$departmentStatus')";
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="m-0">Add Department</h4>
                ...
                <div class="card-body">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="departmentStatus" id="departmentStatus" class="form-control">
